...
namespace UnknownMod.Editor
{
    public partial class MapViewport
    {
        ...
        private void SpawnVisualLayers(ZoneDef zone)
        {
            ...
            if (baseLayers != null)
            {
                foreach (var baseLayer in baseLayers)
                {
                    ...
                    {
                        // No override â€” include base layer (even if hidden/disabled)
        ...
        private void SpawnClonedLayer(VisualLayerDef layer, ZoneDef zone)
        {
            ...
            if (templateGO == null)
            {
                // No cached clone available â€” just track the def in the panel
                _activeLayers.Add(layer);
                return;
            }
        ...
        private void DrawLayersPanel(ZoneDef zone)
        {
            ...
            for (int i = 0; i < _activeLayers.Count; i++)
            {
                ...
                // â”€â”€ Expanded property editor â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                if (isExpanded)
                {
            ...
            // â”€â”€ MapPieces section â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            else
            {
                ...
                if (changed && go != null)
                {
                    ...
                    if (layer.Name == "[Nodes]")
                    {
                        ...
                        // Roads use world-space coords including NodesOffset â€” force rebuild
                        _loadedZoneId = null;
                    }
                }
            }
        ...
        private void CreateNodeVisual(string nodeId, float localX, float localY, ZoneDef zone)
        {
            ...
            // â”€â”€ Base node shape ("plain") â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            // â”€â”€ Node type icon â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            // â”€â”€ MapPiece children â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
