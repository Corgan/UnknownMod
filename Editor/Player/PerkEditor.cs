...
namespace UnknownMod.Editor
{
    ...
    public class PerkEditor : ModProjectEditorBase<PerkDef>
    {
        ...
        protected override EntityPicker.Mode? PickerMode => EntityPicker.Mode.Perk;
        ...
        protected override string GetDisplayName(PerkDef def)
            => !string.IsNullOrEmpty(def.CustomDescription) ? def.CustomDescription : def.Id;
        ...
        protected override void DrawAllSections(PerkDef d, ModProject proj)
        {
            ...
            if (EditorFields.Section("Identity", ref _secIdentity))
            {
                ...
                var perkIds = EditorFields.CachedIds("perk", DataHelper.GetAllPerkIds);
                d.SpriteSource = EditorFields.IdDropdown("Sprite Source", d.SpriteSource, perkIds, "perk_sprsrc", pickerMode: EntityPicker.Mode.Perk);
            }
            ...
            if (EditorFields.Section("Aura/Curse Bonus", ref _secAcBonus))
            {
                ...
                d.AuracurseBonus = EditorFields.IdDropdown("AC ID", d.AuracurseBonus, acIds, "perk_acbonus", pickerMode: EntityPicker.Mode.AuraCurse);
