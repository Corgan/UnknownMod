...
namespace UnknownMod.Definitions
{
    ...
    public class SpriteOverrideDef
    {
        ...
        public float HueShift = 0f;        // 0-1 (wraps 360Â°)
        ...
        /// More aggressive than Hidden â€” the bone's sprite is fully destroyed at runtime.
        /// </summary>
    ...
    /// The mode system has been removed â€” all features are always available.</summary>
