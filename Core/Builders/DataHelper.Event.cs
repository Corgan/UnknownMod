...
namespace UnknownMod.Core
{
    ...
    public static partial class DataHelper
    {
            ...
            System.Func<string, LootData> getLoot)
        {
            ...
            {
                var pack = Globals.Instance?.GetCardPlayerPackData(o.CardPlayerGamePackId.ToLower());
                if (pack != null) t.Field($"{p}CardPlayerGamePackData").SetValue(pack);
            }
            if (!string.IsNullOrEmpty(o.CardPlayerPairsGamePackId))
            {
                var pack = Globals.Instance?.GetCardPlayerPairsPackData(o.CardPlayerPairsGamePackId.ToLower());
