...
namespace UnknownMod.Core
{
    public static partial class ZoneEditingService
    {
        ...
        public static void HotReloadToGame()
        {
            if (CurrentZone == null)
            {
                Plugin.Log.LogWarning("[HotReload] No zone loaded â€” nothing to reload.");
                return;
            }
            ...
            // â”€â”€ 1. Rebuild SOs in Globals â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            try
            {
                if (isPatch)
                {
            ...
            // â”€â”€ 2. Rebuild map visuals if on Map scene â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            // â”€â”€ 3. Combat notice â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            if (MatchManager.Instance != null)
                Plugin.Log.LogWarning("[HotReload] In combat â€” changes will take effect after restarting the encounter.");
        ...
        //  Uses Globals.Instance directly â€” no local SO dicts.
        // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
        ...
        public static void RebuildCombat(string combatId)
        {
            ...
            try
            {
                ...
                // Update nodeâ†’combat references
                ...
                // Update event replyâ†’combat references
